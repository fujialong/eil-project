...
@Service
@Slf4j
public class GradingService2Impl implements IGradingService2 {
...
//        BlockingQueue<Runnable> workQuene2 = new LinkedBlockingQueue<>();
//        ThreadPoolExecutor executor2 = new ThreadPoolExecutor(THREAD_POOL_SIZE, MAX_THREAD_POOL_SIZE,
//                0, TimeUnit.MICROSECONDS, workQuene2);
