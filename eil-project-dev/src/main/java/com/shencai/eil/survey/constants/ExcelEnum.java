...
public enum ExcelEnum {
    ...
    TECHNIQUE_CELL("主要工艺单元"),
    CONTAINER_PRESSURE("内部压力"),
    TEMPERATURE("内部温度"),
    PIPELINE_INTERNAL_DIAMETER("管道内径"),
    HEIGHT("储罐高度"),
    DETECTION_SYSTEM_CLASSIFICATION("探测系统级别"),
    ISOLATION_SYSTEM_CLASSIFICATION("隔离系统级别"),
