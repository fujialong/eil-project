...
public interface EntSurveyPlanMapper extends BaseMapper<EntSurveyPlan> {
    List<EntSurveyPlanVO> pageBasicSurveyPlan(Page<EntSurveyPlanVO> page, EntSurveyPlanQueryParam queryParam);

    List<EntSurveyPlanVO> pageIntensiveSurveyPlan(Page<EntSurveyPlanVO> page, EntSurveyPlanQueryParam queryParam);
}
